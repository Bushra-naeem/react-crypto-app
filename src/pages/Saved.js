...
const Saved = () => {
  ...
  return (
    <section className="w-[90%] lg:w-[80%] h-full flex flex-col mt-16 mb-24 relative">
      <div className="w-full min-h-[60vh] py-2 border border-gray-100 rounded">
        {savedData ? (
              ...
              {savedData.map((data) => {
                return (
                  ...
                  >
                    ...
                    <td className="py-4 hidden sm:table-cell">{data.name}</td>
                    <td className="py-4">
          ...
          <h1 className="min-h-[60vh] text-[20px] sm:text-lg text-cyan flex items-center justify-center">
