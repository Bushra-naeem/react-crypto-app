...
const TrendingCoin = ({ data }) => {
  return (
    <div
      className="w-[90%] lg:w-[40%] bg-gray-200 mb-12
    last:mb-0 rounded-lg p-2 lg:p-4 relative cursor-pointer
      ...
      {data ? (
        <>
          ...
          <img
            src={data.large}
            alt={data.name}
            className="w-[25%] lg:w-[30%] h-auto rounded-full absolute top-6 lg:top-2/4 -right-5 sm:-right-12
            -translate-y-2/4
            "
          />
        </>
