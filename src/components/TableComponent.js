...
const TableComponent = () => {
  ...
  return (
    <>
      <div className="flex flex-col mt-4 lg:mt-10 border border-gray-100 rounded">
        {cryptoData ? (
      ...
      <div className="flex flex-col md:flex-row gap-4 my-5 items-center justify-between capitalize h-[2rem]">
        <span>
          Data provided by{" "}
          <a
            className="text-cyan"
